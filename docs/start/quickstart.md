...
> **Note:** If you used `npx` for setup, always use `npx penclipai` to run commands. The `pnpm penclipai` form only works inside a cloned copy of the Paperclip repository (see Local Development below).
