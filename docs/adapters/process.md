...
- Running a Python script that calls the PrivateClip API
...
1. PrivateClip spawns the configured command as a child process
2. Standard PrivateClip environment variables are injected (`PAPERCLIP_AGENT_ID`, `PAPERCLIP_API_KEY`, etc.)
...
The script can use the injected environment variables to authenticate with the PrivateClip API and perform work.
