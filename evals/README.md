...
Eval framework for testing PrivateClip agent behaviors across models and prompt versions.
...
Phase 0 covers narrow behavior evals for the PrivateClip heartbeat skill:
