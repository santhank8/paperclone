...
`agent local-cli` is the quickest way to run local Claude/Codex/OpenCode manually as a Paperclip agent:

- creates a new long-lived agent API key
- installs missing Paperclip skills into `~/.codex/skills`, `~/.claude/skills`, and `~/.config/opencode/skills`
...
pnpm paperclipai agent local-cli opencodecoder --company-id <company-id>
```
