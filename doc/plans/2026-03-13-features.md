...
- fully managed PrivateClip SaaS
...
- Team of 3 can use one shared PrivateClip instance.
...
PrivateClip should manage the **issue → workspace → preview/PR → review handoff** lifecycle, but leave diffs/review/merge to external tools.
...
- A chat plugin can converse without requiring chat to become the core PrivateClip product.
...
- **Keep** PrivateClip as the board-level control plane.
