...
Low-level reference for how PrivateClip packages are prepared and published to npm.
...
PrivateClip no longer uses release branches or Changesets for publishing.
...
PrivateClip uses calendar versions:
