...
This document covers the GitHub and npm setup required for the current PrivateClip release model:
...
Do this for every public package that PrivateClip publishes.
...
2. revoke any personal automation token that used to publish PrivateClip
