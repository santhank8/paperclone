...
/**
 * GET /api/nansen/profiler/balances
...
export async function GET(request: Request) {
  try {
    ...
    const balances = await nansenAPI.getAddressBalances(address, chain);
    ...
    return NextResponse.json({ error: 'Failed to fetch address balances', details: error.message }, { status: 500 });
  }
}
