...
| Scope | Use for |
|-------|---------|
| `custom:portal2-qa` | Test strategies, test data, QA procedures, test environments, flaky tests |
| `custom:portal2` | READ ONLY — General Portal2 architecture, shared configs, cross-cutting concerns |

### Rules
- **Store** to `custom:portal2-qa` scope
- **Recall** from both `custom:portal2-qa` and `custom:portal2` when researching
