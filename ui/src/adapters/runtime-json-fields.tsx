...
import { Field, useAgentConfigHelp } from "../components/agent-config-primitives";
...
export function RuntimeServicesJsonField({
  ...
  return (
    <Field label={t("executionWorkspace.runtimeServicesJson")} hint={help.runtimeServicesJson}>
      <textarea
