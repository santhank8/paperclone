...
export const issueStatusIcon: Record<string, string> = {
  ...
  claimed: "text-cyan-600 border-cyan-600 dark:text-cyan-400 dark:border-cyan-400",
  in_progress: "text-yellow-600 border-yellow-600 dark:text-yellow-400 dark:border-yellow-400",
  handoff_ready: "text-indigo-600 border-indigo-600 dark:text-indigo-400 dark:border-indigo-400",
  technical_review: "text-violet-600 border-violet-600 dark:text-violet-400 dark:border-violet-400",
  changes_requested: "text-orange-600 border-orange-600 dark:text-orange-400 dark:border-orange-400",
  human_review: "text-emerald-600 border-emerald-600 dark:text-emerald-400 dark:border-emerald-400",
...
export const issueStatusText: Record<string, string> = {
  ...
  claimed: "text-cyan-600 dark:text-cyan-400",
  in_progress: "text-yellow-600 dark:text-yellow-400",
  handoff_ready: "text-indigo-600 dark:text-indigo-400",
  technical_review: "text-violet-600 dark:text-violet-400",
...
export const statusBadge: Record<string, string> = {
  ...
  handoff_ready: "bg-indigo-100 text-indigo-700 dark:bg-indigo-900/50 dark:text-indigo-300",
  technical_review: "bg-violet-100 text-violet-700 dark:bg-violet-900/50 dark:text-violet-300",
  changes_requested: "bg-orange-100 text-orange-700 dark:bg-orange-900/50 dark:text-orange-300",
  human_review: "bg-emerald-100 text-emerald-700 dark:bg-emerald-900/50 dark:text-emerald-300",
