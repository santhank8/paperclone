...
export const runTranscriptFixtureEntries: TranscriptEntry[] = [
  ...
  },
  {
    ...
    text: "I’m starting with the PrivateClip heartbeat procedure and the repo-required docs so I can see what task is actually assigned and then work only on that scope.",
  },
  {
    kind: "tool_call",
  ...
  },
  {
    ...
    toolUseId: "item_1",
    content: "command: sed -n '1,220p' doc/GOAL.md\nstatus: completed\nexit_code: 0\n\n# PrivateClip\n\nPrivateClip is the backbone of the autonomous economy.",
    isError: false,
  },
  {
    kind: "tool_result",
