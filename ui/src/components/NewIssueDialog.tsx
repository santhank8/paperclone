...
const statuses = [
  { value: "backlog", label: "Lista de espera", color: issueStatusText.backlog ?? issueStatusTextDefault },
  ...
  { value: "done", label: "Concluída", color: issueStatusText.done ?? issueStatusTextDefault },
];
...
export function NewIssueDialog() {
    ...
    onSuccess: ({ issue, companyId, failures }) => {
      ...
      if (failures.length > 0) {
        ...
        pushToast({
          ...
          tone: "warn",
          action: prefix
            ? { label: `Abrir ${issueRef}`, href: `/${prefix}/issues/${issueRef}` }
            : undefined,
        });
      }
      clearDraft();
  ...
  const createIssueErrorMessage =
    createIssue.error instanceof Error ? createIssue.error.message : "Falha ao criar a issue. Tente novamente.";
          ...
          <div className="px-4 py-3 shrink-0 space-y-2">
            <div className="space-y-1.5">
              ...
              <div className="text-[11px] text-muted-foreground">
                Controle se esta issue roda no workspace compartilhado, em um novo workspace isolado ou em um já existente.
              </div>
              <select
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <span className="inline-flex items-center justify-center gap-1.5">
                ...
                <span>{createIssue.isPending ? "Criando..." : "Criar issue"}</span>
              </span>
            </Button>
          </div>
        </div>
