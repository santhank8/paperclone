      ...
      >
          ...
          <div className="px-4 pb-2 shrink-0">
            ...
            {assigneeOptionsOpen && (
              <div className="mt-2 rounded-md border border-border p-3 bg-muted/20 space-y-3">
                ...
                <div className="flex items-center justify-between rounded-md border border-border px-2 py-1.5">
                  <div className="text-xs text-muted-foreground">{t('issues.useProjectWorkspace')}</div>
                  <button
                    className={cn(
                      "relative inline-flex h-5 w-9 items-center rounded-full transition-colors",
        ...
        <div className="flex items-center gap-1.5 px-4 py-2 border-t border-border flex-wrap shrink-0">
          ...
          >
            ...
            {uploadDescriptionImage.isPending ? t('common.uploading') : t('common.image')}
          </button>
        ...
        <div className="flex items-center justify-between px-4 py-2.5 border-t border-border shrink-0">
          ...
          >
            {createIssue.isPending ? t('common.creating') : t('issues.createIssue')}
          </Button>
        </div>
      </DialogContent>
    </Dialog>
