...
const SURFACES = [
  {
    title: "推理账本",
    description: "来自 cost_events 的请求级用量与计费运行记录。",
    icon: Database,
    points: ["令牌 + 计费金额", "提供商、计费方、模型", "订阅与超额感知"],
    tone: "from-sky-500/12 via-sky-500/6 to-transparent",
  },
  {
    title: "财务账本",
    description: "非单次提示-响应对的账户级收费。",
    icon: ReceiptText,
    points: ["充值、退款、手续费", "Bedrock 预置或训练费用", "额度到期与调整"],
    tone: "from-amber-500/14 via-amber-500/6 to-transparent",
  },
  {
    title: "实时配额",
    description: "可实时阻断流量的提供商或计费方窗口。",
    icon: Gauge,
    points: ["提供商配额窗口", "计费方额度系统", "错误直接暴露"],
    ...
    <Card className="relative overflow-hidden border-border/70">
      ...
      <CardHeader className="relative px-5 pt-5 pb-2">
        ...
        <CardDescription className="max-w-2xl text-sm leading-6">
          Paperclip 现已将请求级推理用量与账户级财务事件分离。
          当计费方为 OpenRouter、Cloudflare、Bedrock 或其他中间商时，这能确保提供商报告的准确性。
        </CardDescription>
      </CardHeader>
