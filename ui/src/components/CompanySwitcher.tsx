  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="start" className="w-[220px]">
        <DropdownMenuLabel>{t("sharedUi.companies")}</DropdownMenuLabel>
        <DropdownMenuSeparator />
