  ...
  const labelsContent = (
    <>
      <input
        ...
        placeholder={t('issues.searchLabels')}
        value={labelSearch}
            ...
            return (
              <div key={label.id} className="flex items-center gap-1">
                ...
                <button
                  ...
                  title={t('issues.deleteLabel', { name: label.name })}
                >
      ...
      <div className="mt-2 border-t border-border pt-2 space-y-1">
        ...
        >
          ...
          {createLabel.isPending ? t('issues.creatingLabel') : t('issues.createLabel')}
        </button>
      </div>
    </>
  );
      ...
      <div className="max-h-48 overflow-y-auto overscroll-contain">
        ...
        {issue.createdByUserId && (
          ...
          >
            ...
            {creatorUserLabel
              ? creatorUserLabel === t('issues.me')
                ? t('issues.assignToMe')
                : t('issues.assignTo', { name: creatorUserLabel })
              : t('issues.assignToRequester')}
          </button>
        )}
        {sortedAgents
          .filter((a) => {
  ...
  return (
    <div className="space-y-4">
      <div className="space-y-1">
        ...
        {issue.parentId && (
          <PropertyRow label={t('issues.parent')}>
            <Link
