...
const quickFilterPresets = [
  { label: "Todas", statuses: [] as string[] },
  { label: "Ativas", statuses: ["todo", "in_progress", "in_review", "blocked"] },
  { label: "Lista de espera", statuses: ["backlog"] },
  { label: "Concluídas", statuses: ["done", "cancelled"] },
];
      ...
      label:
        key === "__unassigned"
          ...
          : key.startsWith("__user:")
            ? (formatAssigneeUserLabel(key.slice("__user:".length), currentUserId) ?? "Usuário")
  ...
  return (
    <div className="space-y-4">
      ...
      {!isLoading && filtered.length === 0 && viewState.viewMode === "list" && (
        <EmptyState
          icon={CircleDot}
          message="Nenhuma tarefa corresponde aos filtros ou à busca atual."
          action="Criar tarefa"
                                ...
                                >
                                  {issue.assigneeAgentId && agentName(issue.assigneeAgentId) ? (
                                    ...
                                    <span className="inline-flex items-center gap-1.5 text-xs">
                                      ...
                                      {formatAssigneeUserLabel(issue.assigneeUserId, currentUserId) ?? "Usuário"}
                                    </span>
                                  ) : (
