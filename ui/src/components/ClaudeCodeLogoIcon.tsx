...
export function ClaudeCodeLogoIcon({ className }: { className?: string }) {
  return (
    <svg fill="currentColor" fillRule="evenodd" viewBox="0 0 24 24" className={cn(className)} xmlns="http://www.w3.org/2000/svg">
