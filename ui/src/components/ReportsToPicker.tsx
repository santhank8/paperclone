...
export function ReportsToPicker({
  ...
  const resolvedDisabledEmptyLabel = disabledEmptyLabel ?? t("sharedUi.reportsToDisabled");
  const resolvedChooseLabel = chooseLabel ?? t("sharedUi.reportsToChoose");
        ...
        >
          {unknownManager ? (
            <>
              ...
              <span className="min-w-0 truncate text-muted-foreground">{t("sharedUi.unknownManager")}</span>
            </>
          ) : current ? (
            <>
              ...
              >
                {t("sharedUi.reportsToLabel", { name: current.name })}{terminatedManager ? ` (${t("sharedUi.terminated")})` : ""}
              </span>
            </>
          ) : (
            <>
