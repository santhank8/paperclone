...
function useWindowLabel() {
  ...
  return (windowKind: BudgetPolicySummary["windowKind"]) =>
    windowKind === "lifetime" ? t("budgetPolicy.lifetimeBudget") : t("budgetPolicy.monthlyBudget");
}
  ...
  const observedBudgetGrid = isPlain ? (
    <div className="grid gap-6 sm:grid-cols-2">
      ...
      <div>
        ...
        <div className="mt-1 text-xs text-muted-foreground">
          {t("budgetPolicy.softAlertAt", { percent: summary.warnPercent })}{summary.paused && summary.pauseReason ? t("budgetPolicy.pauseSuffix", { reason: summary.pauseReason }) : ""}
        </div>
      </div>
    </div>
  ) : (
