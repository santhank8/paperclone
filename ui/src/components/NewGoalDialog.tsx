...
export function NewGoalDialog() {
  ...
  const levelLabels: Record<string, string> = {
    company: t("newGoalDialog.levelLabels.company"),
    team: t("newGoalDialog.levelLabels.team"),
    agent: t("newGoalDialog.levelLabels.agent"),
    task: t("newGoalDialog.levelLabels.task"),
  };
