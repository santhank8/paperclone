...
export const help: Record<string, string> = {
  ...
  workspaceStrategy: "Como o neurOS deve materializar um workspace de execucao para este agente. Mantenha project_primary para execucao normal no cwd ou use git_worktree para checkouts isolados por tarefa.",
  ...
  bootstrapPrompt: "Enviado apenas quando o neurOS inicia uma sessao nova. Use isto para orientacoes estaveis de configuracao que nao devem ser repetidas em cada heartbeat.",
  payloadTemplateJson: "JSON opcional mesclado aos payloads de requisicao de adaptadores remotos antes de o neurOS adicionar seus campos padrao de wake e workspace.",
