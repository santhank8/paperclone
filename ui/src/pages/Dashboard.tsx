      ...
      {data && (
        <>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            <ChartCard title={t("dashboard.chart.runActivity")} subtitle={t("dashboard.last14")}>
              <RunActivityChart runs={runs ?? []} />
            </ChartCard>
            <ChartCard title={t("dashboard.chart.issuesByPriority")} subtitle={t("dashboard.last14")}>
              <PriorityChart issues={issues ?? []} />
            </ChartCard>
            <ChartCard title={t("dashboard.chart.issuesByStatus")} subtitle={t("dashboard.last14")}>
              <IssueStatusChart issues={issues ?? []} />
            </ChartCard>
            <ChartCard title={t("dashboard.chart.successRate")} subtitle={t("dashboard.last14")}>
