    ...
    if (companies.length === 0) {
      return (
        <EmptyState
          ...
          message={t("emptyState.welcomeToPaperclip")}
          action={t("dashboard.onboarding")}
          onAction={openOnboarding}
        />
      );
    }
    return (
      <EmptyState icon={LayoutDashboard} message={t("emptyState.selectCompanyDashboard")} />
    );
  }
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-xs text-red-100/70">
                    {t("dashboard.agentsPausedProjectsPausedApprovals", {
