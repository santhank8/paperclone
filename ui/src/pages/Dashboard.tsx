    ...
    if (companies.length === 0) {
      return (
        <EmptyState
          ...
          message={translateText("Welcome to Paperclip. Set up your first company and agent to get started.")}
          action={translateText("Get Started")}
          onAction={openOnboarding}
        />
      );
    }
    return (
      <EmptyState icon={LayoutDashboard} message={translateText("Create or select a company to view the dashboard.")} />
    );
  }
        ...
        <>
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-xs text-red-100/70">
                    {data.budgets.pausedAgents} {translateText("agents")} {translateText("paused")} · {data.budgets.pausedProjects} {translateText("Projects").toLowerCase()} {translateText("paused")} · {data.budgets.pendingApprovals} {translateText("budget overrides awaiting board review")}
                  </p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-2 xl:grid-cols-4 gap-1 sm:gap-2">
            <MetricCard
              ...
              label={translateText("Agents Enabled")}
              to="/agents"
              description={
                <span>
            ...
            <MetricCard
              ...
              label={translateText("Tasks In Progress")}
              to="/issues"
              description={
                <span>
            ...
            <MetricCard
              ...
              label={translateText("Month Spend")}
              to="/costs"
              description={
                <span>
            ...
            <MetricCard
              ...
              label={translateText("Pending Approvals")}
              to="/approvals"
              description={
                <span>
