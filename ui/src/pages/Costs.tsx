  ...
  return (
    <Card>
      <CardHeader className="px-5 pt-5 pb-2">
        ...
        <CardDescription>
          {t("pages.costs.financeLedgerDesc")}
        </CardDescription>
      </CardHeader>
    ...
    <div className="space-y-6">
      <div className="space-y-5">
          ...
          <div className="grid gap-3 lg:grid-cols-4">
            <MetricTile
              ...
              subtitle={t("pages.costs.tokensAcrossEvents", { tokens: formatTokens(inferenceTokenTotal) })}
              icon={DollarSign}
            />
            <MetricTile
              ...
              subtitle={
                activeBudgetIncidents.length > 0
                  ? t("pages.costs.agentsPausedProjectsPaused", { agentCount: budgetData?.pausedAgentCount ?? 0, projectCount: budgetData?.pausedProjectCount ?? 0 })
                  : spendData?.summary.budgetCents && spendData.summary.budgetCents > 0
      ...
      <Tabs value={mainTab} onValueChange={(value) => setMainTab(value as typeof mainTab)}>
        <TabsList variant="line" className="justify-start">
          <TabsTrigger value="overview">{t("pages.costs.overview")}</TabsTrigger>
          <TabsTrigger value="budgets">{t("pages.costs.budgets")}</TabsTrigger>
          <TabsTrigger value="providers">{t("pages.costs.providers")}</TabsTrigger>
          <TabsTrigger value="billers">{t("pages.costs.billers")}</TabsTrigger>
          <TabsTrigger value="finance">{t("pages.costs.finance")}</TabsTrigger>
        </TabsList>
              ...
              <div className="grid gap-4 xl:grid-cols-[1.3fr,1fr]">
                <Card>
                  <CardHeader className="px-5 pt-5 pb-2">
                    ...
                    <CardDescription>
                      {t("pages.costs.inferenceLedgerDesc")}
                    </CardDescription>
                  </CardHeader>
                    ...
                    <div className="flex flex-wrap items-end justify-between gap-3">
                      <div>
                        ...
                        <div className="mt-1 text-sm text-muted-foreground">
                          {spendData?.summary.budgetCents && spendData.summary.budgetCents > 0
                            ? t("pages.costs.budgetAmount", { amount: formatCents(spendData.summary.budgetCents) })
                    ...
                    {spendData?.summary.budgetCents && spendData.summary.budgetCents > 0 ? (
                      <div className="space-y-2">
                        ...
                        <div className="text-xs text-muted-foreground">
                          {t("pages.costs.monthlyBudgetConsumed", { percent: spendData.summary.utilizationPercent })}
                        </div>
                      </div>
                    ) : null}
                  </CardContent>
              ...
              <div className="grid gap-4 xl:grid-cols-[1.25fr,0.95fr]">
                <Card>
                  <CardHeader className="px-5 pt-5 pb-2">
                    ...
                    <CardDescription>{t("pages.costs.byAgentDesc")}</CardDescription>
                  </CardHeader>
                ...
                <div className="space-y-4">
                  <Card>
                    <CardHeader className="px-5 pt-5 pb-2">
                      ...
                      <CardDescription>{t("pages.costs.byProjectDesc")}</CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-2 px-5 pb-5 pt-2">
            ...
            <>
              <Card className="border-border/70 bg-[linear-gradient(180deg,rgba(255,255,255,0.05),rgba(255,255,255,0.02))]">
                <CardHeader className="px-5 pt-5 pb-3">
                  ...
                  <CardDescription>
                    {t("pages.costs.budgetControlPlaneDesc")}
                  </CardDescription>
                </CardHeader>
              ...
              {activeBudgetIncidents.length > 0 ? (
                <div className="space-y-3">
                  <div>
                    <h2 className="text-lg font-semibold">{t("pages.costs.activeIncidentsTitle")}</h2>
                    <p className="text-sm text-muted-foreground">
                      {t("pages.costs.resolveIncidentsDesc")}
                    </p>
                  </div>
                  <div className="grid gap-4 xl:grid-cols-2">
                  ...
                  return (
                    <section key={scopeType} className="space-y-3">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          {scopeType === "company"
                            ? t("pages.costs.companyBudgetDesc")
                            : scopeType === "agent"
                              ? t("pages.costs.agentBudgetDesc")
                              : t("pages.costs.projectBudgetDesc")}
                        </p>
                      </div>
                      <div className="grid gap-4 xl:grid-cols-2">
                        {rows.map((summary) => (
                ...
                <div className="space-y-4">
                  <Card>
                    <CardHeader className="px-5 pt-5 pb-2">
                      ...
                      <CardDescription>{t("pages.costs.byBillerDesc")}</CardDescription>
                    </CardHeader>
