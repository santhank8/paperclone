    ...
    <Card>
      ...
      <CardContent className="grid gap-3 px-5 pb-5 pt-2 sm:grid-cols-2 xl:grid-cols-4">
        <MetricTile
          ...
          subtitle={`${eventCount} ${eventCount === 1 ? t.costs.totalEvents : t.costs.totalEventsPlural}`}
          icon={ArrowUpRight}
        />
        <MetricTile
      ...
      <div className="space-y-5">
          ...
          <div className="grid gap-3 lg:grid-cols-4">
            <MetricTile
              ...
              subtitle={`${formatTokens(inferenceTokenTotal)} ${t.costs.tokensAcrossEvents}`}
              icon={DollarSign}
            />
            <MetricTile
                    ...
                    {spendData?.summary.budgetCents && spendData.summary.budgetCents > 0 ? (
                      <div className="space-y-2">
                        ...
                        <div className="text-xs text-muted-foreground">
                          {spendData.summary.utilizationPercent}{t.costs.utilizationPercent}
                        </div>
                      </div>
                    ) : null}
                  </CardContent>
