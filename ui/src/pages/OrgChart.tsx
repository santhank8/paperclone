...
export function OrgChart() {
  ...
  if (!selectedCompanyId) {
    return <EmptyState icon={Network} message={t("pages.org.selectCompanyOrgChart")} />;
  }
  ...
  if (orgTree && orgTree.length === 0) {
    return <EmptyState icon={Network} message={t("pages.org.noHierarchy")} />;
  }
    ...
    <div className="mb-2 flex items-center justify-start gap-2 shrink-0">
      <Link to="/company/import">
        <Button variant="outline" size="sm">
          ...
          {t("pages.org.importCompany")}
        </Button>
      </Link>
      <Link to="/company/export">
        <Button variant="outline" size="sm">
          <Download className="mr-1.5 h-3.5 w-3.5" />
          {t("pages.org.exportCompany")}
        </Button>
      </Link>
    </div>
    <div
    ...
    >
      ...
      <div className="absolute top-3 right-3 z-10 flex flex-col gap-1">
        ...
        <button
          ...
          aria-label={t("pages.org.zoomOut")}
        >
          &minus;
        </button>
        <button
          ...
          title={t("pages.org.fitToScreen")}
          aria-label={t("pages.org.fitToScreen")}
        >
          {t("pages.org.fit")}
        </button>
      </div>
