...
const ACTION_LABEL_KEYS: Record<string, string> = {
  "issue.created": "issueDetail.actionCreatedIssue",
  "issue.updated": "issueDetail.actionUpdatedIssue",
  ...
  "issue.deleted": "issueDetail.actionDeletedIssue",
  "agent.created": "issueDetail.actionCreatedAgent",
  "agent.updated": "issueDetail.actionUpdatedAgent",
  "agent.paused": "issueDetail.actionPausedAgent",
  "agent.resumed": "issueDetail.actionResumedAgent",
  "agent.terminated": "issueDetail.actionTerminatedAgent",
  "heartbeat.invoked": "issueDetail.actionInvokedHeartbeat",
  "heartbeat.cancelled": "issueDetail.actionCancelledHeartbeat",
  "approval.created": "issueDetail.actionRequestedApproval",
  "approval.approved": "issueDetail.actionApproved",
  "approval.rejected": "issueDetail.actionRejected",
};
...
export function IssueDetail() {
  ...
  const commentReassignOptions = useMemo(() => {
    ...
    if (currentUserId) {
      const label = currentUserId === "local-board" ? t("issueDetail.board") : t("issueDetail.meBoard");
        ...
        <div className="flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              {uploadAttachment.isPending ? t("common.uploading") : t("issueDetail.uploadImage")}
            </Button>
          </div>
        </div>
                ...
                {isImageAttachment(attachment) && (
                  <a href={attachment.contentPath} target="_blank" rel="noreferrer">
                    <img
                      ...
                      alt={attachment.originalFilename ?? t("issueDetail.attachment")}
                  ...
                  {issueCostSummary.hasTokens && (
                    <span>
                      ...
                      {issueCostSummary.cached > 0
                        ? ` (${t("issueDetail.tokenIn")} ${formatTokens(issueCostSummary.input)}, ${t("issueDetail.tokenOut")} ${formatTokens(issueCostSummary.output)}, ${t("issueDetail.tokenCached")} ${formatTokens(issueCostSummary.cached)})`
                        : ` (${t("issueDetail.tokenIn")} ${formatTokens(issueCostSummary.input)}, ${t("issueDetail.tokenOut")} ${formatTokens(issueCostSummary.output)})`}
                    </span>
                  )}
                </div>
              )}
