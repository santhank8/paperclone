...
export function CompanySettings() {
  ...
  useEffect(() => {
    setBreadcrumbs([
      { label: selectedCompany?.name ?? t("section.company"), href: "/dashboard" },
    ...
    <div className="max-w-2xl space-y-6">
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <input
                    ...
                    placeholder={t("pages.companySettings.auto")}
      ...
      {generalDirty && (
        <div className="flex items-center gap-2">
          ...
          >
            {generalMutation.isPending ? t("button.saving") : t("pages.companySettings.saveChanges")}
          </Button>
        ...
        <div className="space-y-3 rounded-md border border-border px-4 py-4">
          <div className="flex items-center gap-1.5">
            <span className="text-xs text-muted-foreground">
              {t("pages.companySettings.generateInviteHint")}
            </span>
            <HintIcon text={t("pages.companySettings.generateInviteTooltip")} />
          </div>
          <div className="flex flex-wrap items-center gap-2">
            ...
            >
              {inviteMutation.isPending
                ...
                : t("pages.companySettings.generateInviteBtn")}
            </Button>
          </div>
          {inviteError && (
      ...
      <div className="space-y-4">
        ...
        <div className="rounded-md border border-border px-4 py-4">
          <p className="text-sm text-muted-foreground">
            {t("pages.companySettings.importExportMoved")}{" "}
            <a href="/org" className="underline hover:text-foreground">{t("pages.companySettings.orgChart")}</a> {t("pages.companySettings.header")}
          </p>
