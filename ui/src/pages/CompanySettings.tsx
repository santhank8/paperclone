...
export function CompanySettings() {
  ...
  const feedbackSharingMutation = useMutation({
    ...
    onSuccess: (_company, enabled) => {
      queryClient.invalidateQueries({ queryKey: queryKeys.companies.all });
      pushToast({
        title: enabled ? t("feedbackSharingEnabled") : t("feedbackSharingDisabledToast"),
        tone: "success",
      });
    },
    onError: (err) => {
      pushToast({
        ...
        body: err instanceof Error ? err.message : t("common:errors.generic"),
        tone: "error",
      });
    },
  });
  ...
  return (
    <div className="max-w-2xl space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3 rounded-md border border-border px-4 py-4">
          <ToggleField
            label={t("feedbackSharingToggle")}
            hint={t("feedbackSharingToggleHint")}
      ...
      <div className="space-y-4">
        ...
        <div className="rounded-md border border-border px-4 py-4">
          <p className="text-sm text-muted-foreground">
            {t("importExportMoved")}{" "}
            <a href="/org" className="underline hover:text-foreground">{t("orgChart")}</a> {t("importExportMovedSuffix")}
          </p>
