...
export function CompanySettings() {
  ...
  useEffect(() => {
    setBreadcrumbs([
      ...
      { label: t("pages.companySettings.title") }
    ]);
    ...
    <div className="max-w-2xl space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3 rounded-md border border-border px-4 py-4">
          <Field label={t("pages.companySettings.name")} hint={t("pages.companySettings.nameHint")}>
            <input
      ...
      {generalDirty && (
        <div className="flex items-center gap-2">
          ...
          >
            {generalMutation.isPending ? t("pages.companySettings.saving") : t("pages.companySettings.save")}
          </Button>
        ...
        <div className="space-y-3 rounded-md border border-border px-4 py-4">
          <div className="flex items-center gap-1.5">
            <span className="text-xs text-muted-foreground">
              {t("pages.companySettings.inviteSnippetHint")}
            </span>
            <HintIcon text={t("pages.companySettings.inviteHintIcon")} />
          </div>
            ...
            <div className="rounded-md border border-border bg-muted/30 p-2">
              <div className="flex items-center justify-between gap-2">
                <div className="text-xs text-muted-foreground">
                  {t("pages.companySettings.invitePromptTitle")}
                </div>
                {snippetCopied && (
                  <span
      ...
      <div className="space-y-4">
        <div className="text-xs font-medium text-destructive uppercase tracking-wide">
          {t("pages.companySettings.danger")}
        </div>
            ...
            <Button
              ...
              onClick={() => {
                ...
                const confirmed = window.confirm(
                  t("pages.companySettings.archiveConfirmDialog", { name: selectedCompany.name })
                );
                if (!confirmed) return;
                const nextCompanyId =
                  companies.find(
