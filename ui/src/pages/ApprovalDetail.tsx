...
export function ApprovalDetail() {
  ...
  return (
    <div className="space-y-6 max-w-3xl">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          {approval.status === "rejected" && approval.type === "hire_agent" && linkedAgentId && (
            <Button
              ...
              onClick={() => {
                if (!window.confirm(t("approvals.confirmDeleteAgent"))) return;
      ...
      <div className="border border-border rounded-lg p-4 space-y-3">
        <h3 className="text-sm font-medium">{t("approvals.commentsCount", { count: comments?.length ?? 0 })}</h3>
        ...
        <div className="flex justify-end">
          ...
          >
            {addCommentMutation.isPending ? t("common.posting") : t("approvals.postComment")}
          </Button>
        </div>
      </div>
    </div>
