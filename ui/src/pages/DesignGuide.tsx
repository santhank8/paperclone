...
export function DesignGuide() {
  ...
  return (
    <div className="space-y-10 max-w-4xl">
      ...
      {/* ============================================================ */}
      <Section title="状态系统">
        <SubSection title="StatusBadge（所有状态）">
          <div className="flex items-center gap-2 flex-wrap">
            {[
      ...
      <Section title="表单元素">
        <div className="grid gap-6 md:grid-cols-2">
          <SubSection title="输入框">
            ...
            <Input placeholder="已禁用输入框" disabled className="mt-2" />
          </SubSection>
          ...
          <SubSection title="复选框和标签">
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <Label htmlFor="check3">已禁用项</Label>
              </div>
            </div>
          </SubSection>
      ...
      <Section title="弹出框">
        <Popover>
          ...
          <PopoverContent className="space-y-2">
            <p className="text-sm font-medium">Agent 心跳</p>
            <p className="text-xs text-muted-foreground">
              上次运行成功于 24 秒前。下次定时运行将在 9 分钟后。
            </p>
        ...
        <Collapsible open={collapsibleOpen} onOpenChange={setCollapsibleOpen} className="space-y-2">
          ...
          <CollapsibleContent className="rounded-md border border-border p-3">
            <div className="space-y-2">
              ...
              <Input id="owner-filter" placeholder="按 Agent 名称筛选" />
            </div>
          </CollapsibleContent>
        </Collapsible>
      </Section>
          ...
          <SheetContent side="right">
            ...
            <div className="space-y-4 px-4">
              <div className="space-y-1">
                ...
                <Input id="sheet-title" defaultValue="完善入门文档" />
              </div>
              <div className="space-y-1">
                <Label htmlFor="sheet-description">描述</Label>
                <Textarea id="sheet-description" defaultValue="记录安装过程中的常见问题和截图。" />
              </div>
            </div>
            <SheetFooter>
      ...
      <Section title="卡片">
        <SubSection title="标准卡片">
          <Card>
            ...
            <CardContent>
              <p className="text-sm">卡片内容在此处。这是主要内容区域。</p>
            </CardContent>
        ...
        <SubSection title="指标卡片">
          <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-4">
            <MetricCard icon={Bot} value={12} label="活跃 Agent" description="本周 +3" />
            <MetricCard icon={CircleDot} value={48} label="待处理任务" />
            <MetricCard icon={DollarSign} value="$1,234" label="月度费用" description="未超预算" />
        ...
        <SubSection title="默认（药丸）样式">
          <Tabs defaultValue="overview">
            ...
            <TabsContent value="runs">
              <p className="text-sm text-muted-foreground py-4">运行记录标签页内容。</p>
            </TabsContent>
            <TabsContent value="config">
              <p className="text-sm text-muted-foreground py-4">配置标签页内容。</p>
            </TabsContent>
            <TabsContent value="costs">
              <p className="text-sm text-muted-foreground py-4">费用标签页内容。</p>
            </TabsContent>
          </Tabs>
        </SubSection>

        <SubSection title="线条样式">
        ...
        <Dialog>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                这是一个示例对话框，展示了包含标题、内容和底部操作栏的标准布局。
              </DialogDescription>
            </DialogHeader>
            <div className="space-y-3">
              <div>
      ...
      <Section title="进度条（预算）">
        <div className="space-y-3">
          {[
            { label: "未超预算 (40%)", pct: 40, color: "bg-green-400" },
      ...
      <Section title="日志查看器">
        <div className="bg-neutral-950 rounded-lg p-3 font-mono text-xs max-h-80 overflow-y-auto">
          <div className="text-foreground">[12:00:01] INFO  Agent 启动成功</div>
          <div className="text-foreground">[12:00:02] INFO  正在处理任务 PAP-001</div>
          <div className="text-yellow-400">[12:00:05] WARN  接近速率限制 (80%)</div>
          <div className="text-foreground">[12:00:08] INFO  任务 PAP-001 已完成</div>
          <div className="text-red-400">[12:00:12] ERROR 连接上游服务超时</div>
          <div className="text-blue-300">[12:00:12] SYS   5 秒后重试连接...</div>
          <div className="text-foreground">[12:00:17] INFO  重新连接成功</div>
        ...
        <div className="space-y-3 max-w-2xl">
          ...
          <div className="space-y-3">
            <div className="rounded-md border border-border p-3">
              ...
              <p className="text-sm">开始处理认证模块。需要配置 API 密钥。</p>
            </div>
            <div className="rounded-md border border-border p-3">
              <div className="flex items-center justify-between mb-1">
              ...
              <p className="text-sm">API 密钥已添加到密钥库。请继续操作。</p>
            </div>
          </div>
          <div className="space-y-2">
