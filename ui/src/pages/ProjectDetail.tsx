  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        aria-label={t("pages.projectDetail.changeColor")}
      />
      {open && (
          ...
          <div className="grid grid-cols-5 gap-1.5">
            {PROJECT_COLORS.map((color) => (
              <button
                ...
                aria-label={t("pages.projectDetail.selectColor", { color })}
              />
            ))}
          </div>
        </div>
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="min-w-0 space-y-2">
          ...
          {project.pauseReason === "budget" ? (
            <div className="inline-flex items-center gap-2 rounded-full border border-red-500/30 bg-red-500/10 px-3 py-1 text-[11px] font-medium uppercase tracking-[0.18em] text-red-200">
              ...
              {t("pages.projectDetail.pausedByBudget")}
            </div>
          ) : null}
        </div>
      </div>
      ...
      <Tabs value={activeTab ?? "list"} onValueChange={(value) => handleTabChange(value as ProjectTab)}>
        <PageTabBar
          items={[
            { value: "list", label: t("pages.projectDetail.tabs.issues") },
            { value: "overview", label: t("pages.projectDetail.tabs.overview") },
            { value: "configuration", label: t("pages.projectDetail.tabs.configuration") },
            { value: "budget", label: t("pages.projectDetail.tabs.budget") },
