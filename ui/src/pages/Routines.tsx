...
function formatLastRunTimestamp(value: Date | string | null | undefined, emptyLabel: string) {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-3 py-2.5 text-muted-foreground">
                        <div>{formatLastRunTimestamp(routine.lastRun?.triggeredAt, t("Never", { defaultValue: "Never" }))}</div>
                        {routine.lastRun ? (
