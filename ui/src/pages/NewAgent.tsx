...
export function NewAgent() {
  ...
  const createAgent = useMutation({
    ...
    onError: (error) => {
      setFormError(error instanceof Error ? error.message : t("newAgent.error.create"));
    },
  });
      ...
      <div className="border border-border">
        ...
        <div className="border-t border-border px-4 py-4">
          <div className="space-y-3">
            <div>
              <h2 className="text-sm font-medium">{t("newAgent.skills.title")}</h2>
        ...
        <div className="border-t border-border px-4 py-3">
          {isFirstAgent && (
            <p className="text-xs text-muted-foreground mb-2">{t("newAgent.ceoNotice")}</p>
          )}
          {formError && (
          ...
          <div className="flex items-center justify-end gap-2">
            ...
            >
              {createAgent.isPending ? t("newAgent.creating") : t("newAgent.createButton")}
            </Button>
          </div>
        </div>
      </div>
