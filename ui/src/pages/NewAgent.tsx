...
export function NewAgent() {
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      <div>
        <h1 className="text-lg font-semibold">{t("pages.newAgent.title")}</h1>
        <p className="text-sm text-muted-foreground mt-1">
          {t("pages.newAgent.subtitle")}
        </p>
      </div>
      ...
      <div className="border border-border">
        ...
        <div className="px-4 pt-4 pb-2">
          <input
            ...
            placeholder={t("pages.newAgent.agentNamePlaceholder")}
            value={name}
        ...
        <div className="px-4 pb-2">
          <input
            ...
            placeholder={t("pages.newAgent.titlePlaceholder")}
            value={title}
              ...
              >
                {currentReportsTo ? (
                  <>
                    ...
                    {t("pages.newAgent.reportsToAgent", { name: currentReportsTo.name })}
                  </>
                ) : (
                  <>
                    <User className="h-3 w-3 text-muted-foreground" />
                    {isFirstAgent ? t("pages.newAgent.reportsToNa") : t("pages.newAgent.reportsToDots")}
                  </>
                )}
              </button>
            </PopoverTrigger>
        ...
        <div className="border-t border-border px-4 py-3">
          {isFirstAgent && (
            <p className="text-xs text-muted-foreground mb-2">{t("pages.newAgent.ceoNote")}</p>
          )}
          {formError && (
          ...
          <div className="flex items-center justify-end gap-2">
            ...
            >
              {createAgent.isPending ? t("pages.newAgent.creating") : t("pages.newAgent.createAgent")}
            </Button>
          </div>
        </div>
      </div>
