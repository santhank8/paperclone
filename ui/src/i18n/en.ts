export const en = {
  ...
  routines: {
    ...
    routineCreatedDescWithAgent: "Add the first trigger to turn it into a live workflow.",
    routineCreatedDescDraft: "Draft saved. Add a default agent before enabling automation.",
