...
export async function execute(ctx: AdapterExecutionContext): Promise<AdapterExecutionResult> {
  ...
  const buildClaudeArgs = (resumeSessionId: string | null) => {
    ...
    if (!dangerouslySkipPermissions && allowedTools && !disallowedTools) args.push("--allowedTools", allowedTools);
    if (!dangerouslySkipPermissions && disallowedTools && !allowedTools) args.push("--disallowedTools", disallowedTools);
