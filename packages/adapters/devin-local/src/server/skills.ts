...
async function buildDevinSkillSnapshot(config: Record<string, unknown>): Promise<AdapterSkillSnapshot> {
  ...
  return buildPersistentSkillSnapshot({
    ...
    missingDetail: "Configured but not currently linked into the Devin skills home.",
