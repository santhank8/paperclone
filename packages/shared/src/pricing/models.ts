...
export function calculateTokenCostCents(
  ...
  // Codex reports cachedInputTokens as a subset of inputTokens (total includes cached).
  // Claude reports them separately. Subtract cached from total to avoid double-counting.
