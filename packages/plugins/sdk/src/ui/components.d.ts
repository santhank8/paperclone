...
export declare const MetricCard: React.ComponentType<TProps>;
/**
 * Displays an inline status badge (ok / warning / error / info / pending).
 *
 * @see PLUGIN_SPEC.md §19.6 — Shared Components
 */
export declare const StatusBadge: React.ComponentType<TProps>;
/**
 * Sortable, paginated data table.
 *
 * @see PLUGIN_SPEC.md §19.6 — Shared Components
 */
export declare const DataTable: React.ComponentType<TProps>;
/**
 * Line or bar chart for time-series data.
 *
 * @see PLUGIN_SPEC.md §19.6 — Shared Components
 */
export declare const TimeseriesChart: React.ComponentType<TProps>;
/**
 * Renders Markdown text as HTML.
 *
 * @see PLUGIN_SPEC.md §19.6 — Shared Components
 */
export declare const MarkdownBlock: React.ComponentType<TProps>;
/**
 * Renders a definition-list of label/value pairs.
 *
 * @see PLUGIN_SPEC.md §19.6 — Shared Components
 */
export declare const KeyValueList: React.ComponentType<TProps>;
/**
 * Row of action buttons wired to the plugin bridge's `performAction` handlers.
 *
 * @see PLUGIN_SPEC.md §19.6 — Shared Components
 */
export declare const ActionBar: React.ComponentType<TProps>;
/**
 * Scrollable, timestamped log output viewer.
 *
 * @see PLUGIN_SPEC.md §19.6 — Shared Components
 */
export declare const LogView: React.ComponentType<TProps>;
/**
 * Collapsible JSON tree for debugging or raw data inspection.
 *
 * @see PLUGIN_SPEC.md §19.6 — Shared Components
 */
export declare const JsonTree: React.ComponentType<TProps>;
/**
 * Loading indicator.
 *
 * @see PLUGIN_SPEC.md §19.6 — Shared Components
 */
export declare const Spinner: React.ComponentType<TProps>;
/**
 ...
 */
export declare const ErrorBoundary: React.ComponentType<TProps>;
