...
export function companyService(db: Db) {
  ...
  const companySelection = {
    ...
    issueLifecycleWebhookUrl: companies.issueLifecycleWebhookUrl,
    notifyIssueCreator: companies.notifyIssueCreator,
    notifyIssueAssigner: companies.notifyIssueAssigner,
