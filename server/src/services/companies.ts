...
export function companyService(db: Db) {
  ...
  return {
    ...
    remove: (id: string) =>
      db.transaction(async (tx) => {
        // Delete all company data in strict FK dependency order.
        // Leaf tables (no dependents) first, then parent tables.

        // --- Tables referencing heartbeat_runs ---
        ...
        // --- Tables referencing execution_workspaces ---
        ...
        // --- Tables referencing company_secrets (versions cascade via FK) ---
