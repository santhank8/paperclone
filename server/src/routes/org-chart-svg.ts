/**
 * Server-side SVG renderer for PrivateClip org charts.
...
function guessRoleTag(node: OrgNode): string {
  ...
  if (role.includes("operations") || role.includes("ops")) return "coo";
  return "default";
}
...
// PrivateClip logo: scaled icon (~16px) + wordmark (13px), vertically centered
const PAPERCLIP_LOGO_SVG = `<g>
  ...
  <text x="22" y="11.5" font-family="system-ui, -apple-system, sans-serif" font-size="13" font-weight="600" fill="currentColor">PrivateClip</text>
</g>`;
