...
from deerflow.channels.message_bus import MessageBus
...
_CHANNEL_REGISTRY: dict[str, str] = {
    "feishu": "deerflow.channels.feishu:FeishuChannel",
    "slack": "deerflow.channels.slack:SlackChannel",
    "telegram": "deerflow.channels.telegram:TelegramChannel",
}
