...
class DeerFlowClient:
    ...
    def install_skill(self, skill_path: str | Path) -> dict:
        ...
        """
        from deerflow.gateway.routers.skills import _validate_skill_frontmatter
    ...
    def upload_files(self, thread_id: str, files: list[str | Path]) -> dict:
        ...
        """
        from deerflow.gateway.routers.uploads import CONVERTIBLE_EXTENSIONS, convert_file_to_markdown
